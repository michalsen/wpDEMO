...
function blackhole_template($ip, $date, $whois, $vars) { 
...
<html lang="en-US">
	<head>
		...
		<style>
			...
			pre {
				...
				color: #fff; background-color: #b34334; 
	...
	<body>
		<div>
			...
			<h5><a target="_blank" href="http://perishablepress.com/blackhole-bad-bots/" title="Blackhole WordPress Plugin">Blackhole for Bad Bots</a></h5>
		</div>
	</body>
</html><?php 
