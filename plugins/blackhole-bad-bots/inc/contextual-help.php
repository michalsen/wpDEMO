...
function blackhole_get_help_sidebar() {
	...
	return '<p><strong>'. esc_html__('More Information', 'blackhole-bad-bots') .'</strong></p>'.
		...
		'<p>'. 
			esc_html__('Visit the', 'blackhole-bad-bots') .' <a target="_blank" href="https://wordpress.org/plugins/blackhole-bad-bots/installation/">'. esc_html__('Blackhole Docs', 'blackhole-bad-bots') .'</a> '. esc_html__('at WordPress.org.', 'blackhole-bad-bots') .
		'</p>'.
		
		'<p><strong>'. esc_html__('Support Blackhole Pro!', 'blackhole-bad-bots') .'</strong></p>'.
		
		'<ul>'.
		'<li><a target="_blank" href="https://plugin-planet.com/blackhole-pro/">'. esc_html__('Get Blackhole Pro&nbsp;&raquo;', 'blackhole-bad-bots') .'</a></li>'.
		'<li><a target="_blank" href="https://m0n.co/donate">'. esc_html__('Make a donation&nbsp;&raquo;', 'blackhole-bad-bots') .'</a></li>'.
		'</ul>'.
...
function blackhole_get_help_pro_info() {
	...
	return array(
		...
		'content' => 
			...
			'<p><strong><a target="_blank" href="https://plugin-planet.com/blackhole-pro/">'. esc_html__('Learn more and get Blackhole Pro at Plugin Planet&nbsp;&raquo;', 'blackhole-bad-bots') .'</a></strong></p>'
		...
		array(
			...
			'content' => 
				...
				'<p>'. 
					...
					' <a target="_blank" href="https://perishablepress.com/blackhole-bad-bots/" title="Protect Your Site with a Blackhole for Bad Bots">'. 
				...
				'<ul>'.
					'<li><a target="_blank" href="https://wordpress.org/plugins/blackhole-bad-bots/">'. esc_html__('View the plugin documentation', 'blackhole-bad-bots') .'</a></li>'.
					'<li><a target="_blank" href="https://wordpress.org/support/plugin/blackhole-bad-bots">'. esc_html__('Report an issue in the Support Forum', 'blackhole-bad-bots') .'</a></li>'. 
					'<li><a target="_blank" href="https://plugin-planet.com/blackhole-pro/#contact">'. esc_html__('Contact the plugin developer for help', 'blackhole-bad-bots') .'</a></li>'.
					'<li><a target="_blank" href="https://plugin-planet.com/blackhole-pro/">'. esc_html__('Check out Blackhole Pro', 'blackhole-bad-bots') .'</a></li>'.
				'</ul>'.
				
				'<p><strong>'. esc_html__('About the Developer', 'blackhole-bad-bots') .'</strong></p>'.
				
				'<p>'. 
					esc_html__('Blackhole Pro is developed by', 'blackhole-bad-bots') .' <a target="_blank" href="https://twitter.com/perishable">'. esc_html__('Jeff Starr', 'blackhole-bad-bots') .'</a>, '.
					esc_html__('10-year WordPress veteran and', 'blackhole-bad-bots') .' <a target="_blank" href="https://wp-tao.com/store/">'. esc_html__('book author', 'blackhole-bad-bots') .'</a>.'.
				'</p>'
		)
	);
		...
		array(
			...
			'content' => 
				...
				'<p>'. 
					...
					' <a target="_blank" href="https://wordpress.org/plugins/blackhole-bad-bots/installation/">'. esc_html__('plugin documentation', 'blackhole-bad-bots') .'</a>.'. 
				'</p>'
	...
	$screen->add_help_tab(
		...
		array(
			...
			'content' => 
				...
				'<ul>'. 
					'<li><a target="_blank" href="http://www.robotstxt.org/">'. esc_html__('Learn more about robots.txt', 'blackhole-bad-bots') .'</a></li>'. 
					'<li><a target="_blank" href="http://searchenginepromotionhelp.com/m/robots-text-tester/robots-checker.php">'. esc_html__('Check your robots.txt rules', 'blackhole-bad-bots') .'</a></li>'. 
				'</ul>'
	...
	$screen->add_help_tab(
		...
		array(
			...
			'content' => 
				...
				'<p><em>'. esc_html__('Default: aolbuild, baidu, bingbot, bingpreview, msnbot, duckduckgo, adsbot-google, googlebot, mediapartners-google, teoma, slurp, yandex', 'blackhole-bad-bots') .'</em></p>'. 
				...
				'<p><em>'. esc_html__('Default: Your server IP address, or blank/none if server IP is not available', 'blackhole-bad-bots') .'</em></p>'
		...
		array(
			...
			'content' => 
				...
				'<p>'. 
					...
					'<a target="_blank" href="https://plugin-planet.com/blackhole-pro/">'. esc_html__('Check out Blackhole Pro&nbsp;&raquo;', 'blackhole-bad-bots') .'</a>'. 
				'</p>'
