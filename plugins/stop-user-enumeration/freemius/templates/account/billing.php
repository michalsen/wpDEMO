    ...
    <div class="postbox">
        <div id="fs_billing">
            ...
            <table id="fs_billing_address"<?php if ( $has_billing ) {
                ...
                <tr>
                    <td><label><span><?php fs_echo( 'business-name', $slug ) ?>:</span> <input id="business_name"
                                                                                               value="<?php echo $billing->business_name ?>"
                ...
                <tr>
                    <td><label><span><?php printf( fs_text( 'address-line-n', $slug ), 1 ) ?>:</span> <input
                                    id="address_street" value="<?php echo $billing->address_street ?>"
                                    placeholder="<?php printf( fs_text( 'address-line-n', $slug ), 1 ) ?>"></label></td>
                    <td><label><span><?php printf( fs_text( 'address-line-n', $slug ), 2 ) ?>:</span> <input
                                    id="address_apt" value="<?php echo $billing->address_apt ?>"
                                    placeholder="<?php printf( fs_text( 'address-line-n', $slug ), 2 ) ?>"></label></td>
                </tr>
                <tr>
                    <td><label><span><?php fs_echo( 'city', $slug ) ?> / <?php fs_echo( 'town', $slug ) ?>:</span>
                            <input id="address_city" value="<?php echo $billing->address_city ?>"
                                   placeholder="<?php fs_echo( 'city', $slug ) ?> / <?php fs_echo( 'town', $slug ) ?>"></label>
                    </td>
                    <td><label><span><?php fs_echo( 'zip-postal-code', $slug ) ?>:</span> <input id="address_zip"
                                                                                                 value="<?php echo $billing->address_zip ?>"
